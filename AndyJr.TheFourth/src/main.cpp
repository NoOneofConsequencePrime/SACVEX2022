...
// RightExpansion       digital_out   B               
// LeftExpansion        digital_out   C               
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    // if (Ct1.getRightLowTrig()) Indexer.set(0);
    // else Indexer.set(1);

    if (Ct1.getRightLowTrig()) {
      RightExpansion.set(1);
      LeftExpansion.set(1);
    } else {
      RightExpansion.set(0);
      LeftExpansion.set(0);
    }
